<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:include href="./components/pages/accessible.html"/>
  <xsl:include href="./components/pages/fast.html"/>
  <xsl:include href="./components/pages/robust-and-efficient.html"/>
